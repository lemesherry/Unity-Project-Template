...
namespace Managers {
    ...
    public class FramesDebugManager: MonoBehaviour {
        ...
        private float _accumulated = 0; // FPS accumulated over the interval
        private int _framesCount = 0; // Frames drawn over the interval
        ...
        private void Update() {
            ...
            if( timeleft <= 0.0 ) {
                currentFPS = _accumulated / _framesCount;
        ...
        private void SetRenderScale() {
            ...
            if( Screen.currentResolution.refreshRateRatio.value <= currentFPS ) return;
